...
__decorate([
    ...
    __metadata("design:type", Number)
], Comment.prototype, "responseCount", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.comments),
    __metadata("design:type", user_entity_1.User)
], Comment.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Comment_1, (comment) => comment.responses),
    __metadata("design:type", Comment)
], Comment.prototype, "comment", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => location_entity_1.Location, (location) => location.comments),
    __metadata("design:type", location_entity_1.Location)
], Comment.prototype, "location", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Comment_1, (response) => response.comment, {
        onDelete: 'CASCADE',
    }),
